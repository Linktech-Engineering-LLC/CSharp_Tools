...
DROP TABLE IF EXISTS `insurance_claim_status_view`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `insurance_claim_status_view` AS SELECT
