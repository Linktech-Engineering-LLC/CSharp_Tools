...
DROP TABLE IF EXISTS `statement_detail_view`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `statement_detail_view` AS SELECT
