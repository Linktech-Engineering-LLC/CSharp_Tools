...
DROP TABLE IF EXISTS `billing_kpi_rollup_view`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `billing_kpi_rollup_view` AS SELECT
