...
DROP TABLE IF EXISTS `visit_financial_snapshot_view`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `visit_financial_snapshot_view` AS SELECT
