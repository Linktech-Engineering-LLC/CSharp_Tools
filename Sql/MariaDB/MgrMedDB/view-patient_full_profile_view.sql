...
DROP TABLE IF EXISTS `patient_full_profile_view`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `patient_full_profile_view` AS SELECT
